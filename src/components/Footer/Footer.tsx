  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.links}>
        ...
        <div className={styles.column}>
          <div className={styles.iconWrapper}><a href="#">Условия сервиса</a></div>
          <div className={styles.languageSwitch}>
            <img
              ...
              alt="#"
            />
            <div className={styles.iconWrapper}><span className={styles.active}>Рус</span></div>
            <div className={styles.iconWrapper}><span>Eng</span></div>
          </div>
        </div>
      </div>
